...
uint8_t rs_smb_tx_get_share(SMBTransaction * tx, const uint8_t ** buffer, uint32_t * buffer_len);
uint8_t rs_smb_tx_get_named_pipe(SMBTransaction * tx, const uint8_t ** buffer, uint32_t * buffer_len);
uint8_t rs_smb_tx_get_stub_data(SMBTransaction * tx, uint8_t direction, const uint8_t ** buffer, uint32_t * buffer_len);
