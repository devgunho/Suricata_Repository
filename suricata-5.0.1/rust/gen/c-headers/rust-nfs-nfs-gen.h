...
int8_t rs_nfs_parse_request(Flow * _flow, NFSState * state, void * _pstate, const uint8_t * input, uint32_t input_len, void * _data);
int8_t rs_nfs_parse_request_tcp_gap(NFSState * state, uint32_t input_len);
int8_t rs_nfs_parse_response(Flow * _flow, NFSState * state, void * _pstate, const uint8_t * input, uint32_t input_len, void * _data);
